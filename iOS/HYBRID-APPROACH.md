...
This document describes the hybrid approach implemented in the ECG HealthKit iOS app, providing flexibility for both backend connectivity and data export.
...
This implementation ensures the ECG HealthKit app works reliably in various scenarios while providing users with maximum flexibility and control over their data.
